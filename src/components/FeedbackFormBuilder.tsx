    ...
    return (
      <div className="bg-white p-6 rounded-lg shadow text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-6 flex-wrap">
          ...
          {/* Download QR */}
          <button onClick={handleDownloadQR} title="Download QR Code (PNG)"
          ...
          {/* Download link as TXT */}
          <button onClick={handleDownloadLink} title="Download Link (TXT)"
          ...
          {/* Email */}
          <a href={`mailto:?subject=${encodeURIComponent('Feedback Form')}&body=${encodeURIComponent(`Please share your feedback using this link:\n${formUrl}`)}`}
          ...
          {typeof navigator !== 'undefined' && 'share' in navigator && (
            <button
              onClick={() => navigator.share({ title: 'Feedback Form', url: formUrl }).catch(() => {})}
              title="Share"
