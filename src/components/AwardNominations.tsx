    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="card text-center w-full max-w-md mx-auto">
          ...
          <p className="text-gray-500 mt-4">Thank you for your interest in the INAN Forms!</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="card text-center w-full max-w-md mx-auto relative">
          ...
          <p className="text-gray-500 mt-4">We appreciate your participation in the INAN Forms!</p>
        </div>
      </div>
    );
  }
