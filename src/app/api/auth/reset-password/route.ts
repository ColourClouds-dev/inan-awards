  ...
  try {
    ...
    try {
      ...
      if (err.code === 'auth/user-not-found') {
        // Return success: true anyway to prevent email enumeration attacks
                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <table cellpadding="0" cellspacing="0" style="margin:24px 0;">
                      <tr>
                        <td style="border-radius:8px;background:#7C3AED;padding:0;">
                          <a href="${resetLink}" style="display:block;padding:14px 28px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;border-radius:8px;">
                            Reset Password
                          </a>
                        </td>
                      </tr>
                    ...
                    <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.5;">
                      Or copy this link: <a href="${resetLink}" style="color:#7C3AED;">${resetLink}</a>
                    </p>
